...
def interactive_loop(
    ...
    # observation : World explanation + few shot example + current data explanation
    ...
    if "llama-3" in model_path.lower() and input_len > 8192:
        print(f"input length is larger than model's max length")
...
def main(args: argparse.Namespace):
    ...
    agent = LLM(model = args.model_path, tensor_parallel_size=args.num_gpus)
